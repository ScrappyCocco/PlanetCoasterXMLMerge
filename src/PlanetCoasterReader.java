 ...
 * The translated phrase is stored into a byte[] because i can store it in UTF-8 (or another encoding)
 */
        ...
        try {
            ...
            if (!start_node.getNodeName().equals("translation")) { //The first node is not "translation"
                ...
                if (!start_node.getNodeName().equals("translation")) { //The xml file is not correct
                    //can't find the start node, error
                    throw new Exception("Bad PlanetCoaster-XML File! Check your XML file");
                }
            }
